                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-5 pr-8">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed max-w-sm mb-8">
                            MARCO ELÍSIO, conectando pessoas, propósitos e produtividade no campo através de uma gestão estratégica, representação rural e sustentabilidade corporativa.
                        </p>
                        ...
                        <div className="flex space-x-4">
                            ...
                            <a href="https://www.linkedin.com/in/marco-elisio-nunes-b4a10930" target="_blank" rel="noopener noreferrer" className="w-10 h-10 border border-gray-700 rounded-full flex items-center justify-center hover:bg-primary hover:border-primary transition-all">
                    ...
                    <div className="lg:col-span-2">
                        <h4 className="font-bold text-white mb-6 text-sm tracking-wider">Quick Links</h4>
